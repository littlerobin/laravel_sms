...
<!--End of Zopim Live Chat Script-->
	...
	{!! HTML::style( asset('assets/callburn/style/css/home.css') ) !!}
	...
	{!! HTML::style( asset('http://fonts.googleapis.com/css?family=Hind:300') ) !!}
	{!! HTML::style( asset('http://fonts.googleapis.com/css?family=Noto+Sans') ) !!}
...
<body>
	...
	{!! HTML::script( asset('assets/callburn/js/home.js') ) !!}
	@yield('scripts')
